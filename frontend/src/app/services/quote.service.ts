...
import { DefaultQuoteLineDto, defaultQuoteLinesDtoToQuoteLines } from "../dto/default-quote-line.dto";
...
export class QuoteService {
  ...
  public getDefaultQuoteLines(page: number = 1, limit: number = 10): Observable<DefaultQuoteLineDto[]> {
    return this.httpClient.get<DefaultQuoteLineDto[]>(`${api.url}/quote/default-quote-lines`).pipe(map(defaultQuoteLinesDtoToQuoteLines));
  }
